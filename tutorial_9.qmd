...
You see that the output looks the same as before, just with more coefficients listed. Notice also that `R` has automatically figured out that `gndr` is a factor variable and included a *dummy* only for women (`gndrFemale`) into the model [see also @Solbakken2019, chapter 8]. 

Now it gets tricky: How do you make sense of these results? Solbakken [-@Solbakken2019, chapters 6 & 8; see also @Kellstedt2018, chapters 10 & 11] explain this.
